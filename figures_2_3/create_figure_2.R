...
mtext(side=2,outer=T,line=2.75,cex=1.75,expression(paste("Mean emigration probability ", italic(d))))
...
mtext(side=1,outer=T,line=3.5,cex=1.75,expression(paste("Normalized population density ",italic(N)[italic(i)]/bar(italic(K)))))
