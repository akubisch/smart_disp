...
lines(info[,1]~trade,type="p",lwd=2,pch=15,col=gray(0.75),cex=1.25)
lines(smooth.spline(info[,1]~trade,df=dfs),lwd=2,,col=gray(0.75),lty="dashed")
lines(info[,2]~trade,type="p",lwd=2,pch=17,col=gray(0.5),cex=1.25)
lines(smooth.spline(info[,2]~trade,df=dfs),lwd=2,,col=gray(0.5),lty="dotdash")
lines(info[,3]~trade,type="p",lwd=2,pch=16,col=gray(0),cex=1.25)
lines(smooth.spline(info[,3]~trade,df=dfs),lwd=2,,col=gray(0),lty="solid")
text(0,par("usr")[[4]]*1.075,"(a)",cex=1.25,xpd=T)
...
lines(info[,1]*trade~trade,type="p",lwd=2,pch=15,col=gray(0.75),cex=1.25)
lines(smooth.spline(info[,1]*trade~trade,df=dfs),lwd=2,col=gray(0.75),lty="dashed")
lines(info[,2]*trade~trade,type="p",lwd=2,pch=17,col=gray(0.5),cex=1.25)
lines(smooth.spline(info[,2]*trade~trade,df=dfs),lwd=2,col=gray(0.5),lty="dotdash")
lines(info[,3]*trade~trade,type="p",lwd=2,pch=16,col=gray(0),cex=1.25)
lines(smooth.spline(info[,3]*trade~trade,df=dfs),lwd=2,col=gray(0),lty="solid")
text(0,par("usr")[[4]]*1.075,"(b)",cex=1.25,xpd=T)
