...
for (e in 1:no_exp) {
  ...
  for (r in 1:reps) {
    ...
    write("# cstar (1/0)", file=para.in, append=T)
    write(cstar[e], file=para.in, append=T)

	write("# trade", file=para.in, append=T)
	write(trade[e], file=para.in, append=T)
